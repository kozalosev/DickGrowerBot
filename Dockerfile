...
ARG USER_CACHE_TIME_SECONDS
ARG USER_SERVICE_TIMEOUT_SECONDS
ARG CHAT_LANGUAGE_CACHE_TIME_SECONDS
ARG CHAT_TOPICS_CACHE_TIME_SECONDS
ARG CHAT_CLEANUP_CACHE_TIME_SECONDS
ARG BOT_ADMIN_CACHE_TIME_SECONDS
...
ARG MSG_SELFDESTRUCT_DELAY_NOTICE_MINUTES
ARG MSG_SELFDESTRUCT_DELAY_REPORT_MINUTES
ARG MSG_SELFDESTRUCT_DELAY_EVENT_MINUTES
ARG MSG_SELFDESTRUCT_DELAY_APPLICATION_MINUTES
...
ARG MSG_SELFDESTRUCT_POLL_SECONDS
ARG MSG_SELFDESTRUCT_BATCH_SIZE
ARG MSG_SELFDESTRUCT_CONCURRENCY
ARG MSG_SELFDESTRUCT_LEASE_SECONDS
ARG MSG_SELFDESTRUCT_INLINE_GROUPS
ARG MSG_SELFDESTRUCT_RETRY_DELAY_SECONDS
ARG MSG_SELFDESTRUCT_MAX_RETRY_DELAY_SECONDS
ARG MSG_SELFDESTRUCT_MAX_ATTEMPTS
ARG MSG_SELFDESTRUCT_TABLE_CLEANING_DELAY_MINUTES
ARG BOT_HTTP_CONNECT_TIMEOUT_SECONDS
ARG BOT_HTTP_TIMEOUT_SECONDS
ARG SUPPORT_CHAT_ID
ARG BAN_LIST_REFRESH_SECONDS
ARG REDIS_HOST
ARG REDIS_PORT
ARG REDIS_PASSWORD
